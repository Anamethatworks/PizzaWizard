...
# Init function
func _init(cost : int, powr : float, name : String = "Default Spell", desc : String = "Does nothing."):
	mana_cost = cost
	power = powr
	spell_name = name
	spell_desc = desc
...
func is_valid_casting(_caster: Node3D) -> bool:
